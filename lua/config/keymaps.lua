...
vim.keymap.set('n', '<leader>=_', '<cmd>vertical wincmd =<cr>', { desc = "Make windows same height" })
vim.keymap.set('n', '<leader>=|', '<cmd>horizontal wincmd =<cr>', { desc = "Make windows same width" })
